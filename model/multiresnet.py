...
class Respath(torch.nn.Module):
	...
	def __init__(self, num_in_filters, num_out_filters, respath_length):
		...
		for i in range(self.respath_length):
			if(i==0):
				self.shortcuts.append(Conv2d_batchnorm(num_in_filters, num_out_filters, kernel_size = (3,3), activation='relu'))
				self.convs.append(Conv2d_batchnorm(num_in_filters, num_out_filters, kernel_size = (5,5),activation='relu'))

				
			else:
				self.shortcuts.append(Conv2d_batchnorm(num_out_filters, num_out_filters, kernel_size = (3,3), activation='relu'))
				self.convs.append(Conv2d_batchnorm(num_out_filters, num_out_filters, kernel_size = (5,5), activation='relu'))
