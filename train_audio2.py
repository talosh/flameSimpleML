...
while epoch < num_epochs + 1:
    ...
    for batch_idx in range(len(source_audio_segments)):
        ...
        if step % 99 == 1:
            ...
            sample_before_mag = librosa.db_to_amplitude(sample_before[0]) * 2
            ...
            sample_after_mag = librosa.db_to_amplitude(sample_after[0]) * 2
            ...
            sample_current_mag = librosa.db_to_amplitude(sample_current[0]) * 2
